...
int main()
{
    ...
    while (true)
    {
        cout << "Option - 1: Insert at Head" << endl;         // error handle done
        cout << "Option - 2: Insert at Tail" << endl;         // error handle done
        cout << "Option - 3: Print linked list" << endl;      // error handle done
        cout << "Option - 4: Insert at any position" << endl; // error handle done
        cout << "Option - 5: Delete Head" << endl;            // error handle done
        cout << "Option - 6: Delete from any position" << endl; // error handle done
